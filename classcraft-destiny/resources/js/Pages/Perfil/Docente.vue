    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="text-center">
        <div class="mb-8">
          ...
          <h1 class="text-4xl font-bold text-white mb-4">Perfil de Docente</h1>
          <p class="text-xl text-gray-300 mb-8">Gestiona tu información como profesor</p>
        </div>

        <div class="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 p-8 mb-8">
          <h2 class="text-2xl font-bold text-white mb-6">Información del Profesor</h2>
          ...
          <div class="space-y-6">
            ...
            <div class="text-left">
              ...
              <div class="bg-gray-700/50 rounded-lg p-3">
                <div class="flex items-center space-x-3">
                  ...
                  <span class="text-white font-medium">Profesor/Docente</span>
                </div>
              </div>
            </div>
            ...
            <div class="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <div class="flex items-start space-x-3">
                ...
                <div>
                  <h3 class="text-blue-300 font-medium mb-1">Acceso de Profesor</h3>
                  <p class="text-blue-200 text-sm">
                    Como profesor, puedes crear y gestionar clases, agregar estudiantes y usar herramientas pedagógicas.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="space-y-4">
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a 
              href="/profesor" 
              class="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200 inline-flex items-center justify-center space-x-2"
            >
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
